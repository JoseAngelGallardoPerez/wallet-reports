...
final class PermissionCheckerClient implements PermissionChecker
{
     ...
     * {@inheritdoc}
     */
    public function Check(array $ctx, \Velmie\Wallet\Permissions\PermissionReq $in)
    {
     ...
     * {@inheritdoc}
     */
    public function CheckAll(array $ctx, \Velmie\Wallet\Permissions\PermissionsReq $in)
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.permissions');
        $ctx = Context::withServiceName($ctx, 'PermissionChecker');
     ...
     * {@inheritdoc}
     */
    public function GetGroupsByIds(array $ctx, \Velmie\Wallet\Permissions\GroupIdsReq $in)
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.permissions');
        $ctx = Context::withServiceName($ctx, 'PermissionChecker');
